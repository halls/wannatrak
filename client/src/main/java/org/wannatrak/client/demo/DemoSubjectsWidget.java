...
public class DemoSubjectsWidget extends SubjectsWidget {

    public DemoSubjectsWidget(Mediator mediator, SubjectsController subjectsController) {
        super(mediator, subjectsController);
    }
}
