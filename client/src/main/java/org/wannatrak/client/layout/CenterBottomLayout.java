...
public class CenterBottomLayout extends AbstractMainWidgetLayout {

    private static final CenterBottomLayout instance = new CenterBottomLayout();

    public static CenterBottomLayout getInstance() {
        return instance;
    }

    private CenterBottomLayout() {
    }
