...
public class ShowRightWidgetCommand extends AbstractMainWidgetLayoutCommand {

    public ShowRightWidgetCommand(Mediator mediator) {
        super(mediator);
    }

    public void executeForCenterBottomLayout(CenterBottomLayout currentMainWidgetLayout) {
        getMediator().unpinMapFromRight();
