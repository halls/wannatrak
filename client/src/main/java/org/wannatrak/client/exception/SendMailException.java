...
/**
 * Created 09.04.2009 20:55:01
 *
 * @author Sergey Grachev
 */
public class SendMailException extends CheckedException {
        ...
        DeferredCommand.addCommand(new com.google.gwt.user.client.Command() {
            public void execute() {
                requestSetNewPassController.showWarning(
                        StringConstants.StringConstantsSingleton.getInstance().remindPassSendMailFail()
                );
            }
        });
    }
