...
/**
 * Created 19.04.2009 15:50:35
 *
 * @author Sergey Grachev
 */
public interface Adapter<S, K, V> {
    void load(@NotNull S store) throws ValidationException, StoreNotFoundException, UnknownStoreException;

    void store(@NotNull S store);

    void setConfiguration(@NotNull Configuration<S, K, V> configuration);
}
