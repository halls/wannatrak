...
public class TestApiModule implements Module {
    ...
    public void configure(Binder binder) {
        ...
        binder.bind(UserWorker.class).to(MockUserWorker.class);
        binder.bind(SubjectWorker.class).to(MockSubjectWorker.class);
        binder.bind(TrackingHandler.class).to(MockTrackingHandler.class);
    }
}
